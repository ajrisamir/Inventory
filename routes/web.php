...
// Add new routes for AI product features
...
Route::post('/ai/suggest-name', [AIController::class, 'suggestName'])->name('ai.suggest-name');
Route::post('/ai/recommend-category', [AIController::class, 'recommendCategory'])->name('ai.recommend-category');
...
// AI Routes
Route::post('/chatbot/message', [AIController::class, 'processMessage'])->name('chatbot.message');
Route::post('/chatbot/voice', [AIController::class, 'processVoice'])->name('chatbot.voice');
